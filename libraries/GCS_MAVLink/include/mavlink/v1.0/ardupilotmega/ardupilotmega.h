...
typedef enum MAV_CMD
{
	...
	MAV_CMD_NAV_DUMMY_WP=84, /* Navigate to MISSION. |Hold time in decimal seconds. (ignored by fixed wing, time to stay at MISSION for rotary wing)| Acceptance radius in meters (if the sphere with this radius is hit, the MISSION counts as reached)| 0 to pass through the WP, if > 0 radius in meters to pass by WP. Positive value for clockwise orbit, negative value for counter-clockwise orbit. Allows trajectory control.| Desired yaw angle at MISSION (rotary wing)| Latitude| Longitude| Altitude|  */
	MAV_CMD_NAV_DUBIN_LEFT=85, /* Perform a LEFT turn segment of a dubins path turn |Duration of time to fly this segment| Empty| Empty| Empty| Empty| Empty| Empty|  */
	MAV_CMD_NAV_DUBIN_RIGHT=86, /* Perform a RIGHT turn segment of a dubins path turn |Duration of time to fly this segment| Empty| Empty| Empty| Empty| Empty| Empty|  */
	MAV_CMD_NAV_DUBIN_STRAIGHT=87, /* Perform a STRAIGHT segment of a dubins path turn |Duration of time to fly this segment| Empty| Empty| Empty| Empty| Empty| Empty|  */
	...
	MAV_CMD_NAV_ALIGN_PATH=214, /* Align the UAV with the next imaging path |uint8_t Angle at which to reach the waypoint; North is 0, South is 180|  Acceptance radius in meters (if the sphere with this radius is hit, the MISSION counts as reached)| Empty| Empty| Latitude| Longitude| Altitude|  */
